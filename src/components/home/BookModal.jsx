...
const BookModal = ({ book, onClose }) => {
    return (
        <div onClick={onClose} className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center'>
            ...
            <div className="text justify-start items-center gap-x-2">
                <BiUserCircle className="text-red-300 text-2xl" />
                <h2 className="my-1">{book.author}</h2>
            </div>
            <p className='mt-4'>Anything u want to showType</p>
            <p className='mt-2'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam ea cum debitis. Consequuntur odio perspiciatis incidunt obcaecati consequatur in voluptates quos nemo, eaque nisi, placeat hic reprehenderit, sit iure dolore.</p>
        </div>
    )
}
